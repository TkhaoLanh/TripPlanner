//
//  SearchStocksTableViewController.swift
//  TripPlanner
//
...
class SearchStocksTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        delegate?.didFinishSearchWith(stockName: StockList?[indexPath.row])
    }
